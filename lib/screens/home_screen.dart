      ...
      child: Column(
        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              _impactItem(Icons.people, '0', 'Kehidupan Terbantu'),
              _impactItem(Icons.favorite, '0', 'Donatur di Seluruh Dunia'),
              _impactItem(Icons.language, '0', 'Negara Terjangkau'),
              _impactItem(Icons.monetization_on, 'Rp 0', 'Dana Terkumpul'),
            ],
          ),
        ],
      ),
